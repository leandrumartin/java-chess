...
{
    ChessBoard board;
    //LegalSquares returns an arrayList of squares that it can be moved by the piece rules
...
*/
    ...
    public void testRookLegalMove()
    {
        ...
        //Check to ensure that there are 14 total possible moves within those 4 arraylists
        assertEquals(14, totalPossibleMoves);
        //Index 0: Get every valid row above the rook until it is at the edge of the board
        ...
        //Index 1: Get every valid col to the left of the rook until the edge of the board
        ...
        //Index 3: Get every valid col to the right of the rook until the edge of the board
